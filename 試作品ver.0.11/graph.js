const ctx = document.getElementById('front_img').getContext('2d');
...
//指の長さ計算・表として表示　後半はtable.js参照
const  feed_click= document.getElementById("feed_b");
...
const  rev_click= document.getElementById("rev_b");
rev_click.addEventListener('click', () => {
  myChart.data.datasets[finger.fore].data[joint.tip].x = (myChart.data.datasets[finger.fore].data[joint.tip].x) * -1
  myChart.update('none');
  console.log(myChart.data.datasets[finger.fore].data[joint.tip].x)
})