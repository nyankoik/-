...
//指の長さ計算・表として表示
const  button_click_event= document.getElementById("feedback_b");
...
//  ]
  ...
  //     row_1.innerHTML = `
  //       <td>${table_name_c[finger[fin]].name}</td>
  //       <td class='empty'></td>
  //       <td class='empty'></td>
  //     `;
  ...
  //   Object.entries(part).forEach(([len_name, Value]) => {
